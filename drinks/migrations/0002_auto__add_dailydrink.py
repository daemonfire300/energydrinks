...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyDrink'
        db.create_table(u'drinks_dailydrink', (
        ...
        db.send_create_signal(u'drinks', ['DailyDrink'])


    def backwards(self, orm):
        # Deleting model 'DailyDrink'
        db.delete_table(u'drinks_dailydrink')
