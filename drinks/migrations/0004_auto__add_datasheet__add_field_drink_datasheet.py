...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'drinks_datasheet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vitamin_c', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'drinks', ['DataSheet'])

        # Adding field 'Drink.datasheet'
        db.add_column(u'drinks_drink', 'datasheet',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['drinks.DataSheet'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DataSheet'
        db.delete_table(u'drinks_datasheet')

        # Deleting field 'Drink.datasheet'
        db.delete_column(u'drinks_drink', 'datasheet_id')
