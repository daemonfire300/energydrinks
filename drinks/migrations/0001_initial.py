...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'drinks_drink', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='unknown drink', max_length=128)),
            ('volume', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('caffeine', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'drinks', ['Drink'])

        # Adding model 'Profile'
        db.create_table(u'drinks_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'drinks', ['Profile'])

        # Adding model 'DrinkStats'
        db.create_table(u'drinks_drinkstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drinks.Profile'])),
            ...
            ('last_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'drinks', ['DrinkStats'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'drinks_profile')

        # Deleting model 'DrinkStats'
        db.delete_table(u'drinks_drinkstats')
